...
public class epl extends JFrame {
	...
	public epl()
	{
		...
		//EPL Image
		this.image = new ImageIcon(getClass().getResource("epl.png"));
		
		this.imgLabel = new JLabel (image);
		this.imgLabel.setBounds(140,20,300,300);
		...
		this.confirmButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e){
				...
				if(stat == "League Table" && season == "2013-'14"){
					epl.this.setVisible(false);
					String seasonStat = "13-'14 EPL Table";
					...
					epl.this.setVisible(false);
					String seasonStat = "13-'14 EPL Goals";
					DisplayFrame disf = new DisplayFrame(seasonStat);
					disf.setVisible(true);
					...
					epl.this.setVisible(false);
					String seasonStat = "13-'14 EPL Assists";
					DisplayFrame disf = new DisplayFrame(seasonStat);
					disf.setVisible(true);
				}
					...
					epl.this.setVisible(false);
					String seasonStat = "14-'15 EPL Table";
					DisplayFrame disf = new DisplayFrame(seasonStat);
					disf.setVisible(true);					
				}
					...
					epl.this.setVisible(false);
					String seasonStat = "14-'15 EPL Goals";
					DisplayFrame disf = new DisplayFrame(seasonStat);
					disf.setVisible(true);
				}
					...
					epl.this.setVisible(false);	
					String seasonStat = "14-'15 EPL Assists";
					DisplayFrame disf = new DisplayFrame(seasonStat);
					disf.setVisible(true);					
				}

				else if((stat == "Select a Stat" && season == "Select a Season") || season == "Select a Season" || stat == "Select a Stat"){
					JOptionPane.showMessageDialog(epl.this, "Please! Select league & stat before pressing 'Confirm'.");	
				}
			}
		});
